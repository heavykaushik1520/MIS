...
//                        .requestMatchers("/auth/welcome", "/auth/addNewUser", "/auth/generateToken").permitAll()
			         ...
			         // ✅ ZONES Access Control
			            .requestMatchers(HttpMethod.POST, "/api/zones").hasAuthority("ROLE_ADMIN")       // Add Zone
			            .requestMatchers(HttpMethod.PUT, "/api/zones/**").hasAuthority("ROLE_ADMIN")      // Update Zone
			            .requestMatchers(HttpMethod.DELETE, "/api/zones/**").hasAuthority("ROLE_ADMIN")   // Delete Zone
//			            .requestMatchers(HttpMethod.GET, "/api/zones/brand/**").hasAuthority("ROLE_ADMIN")
			            ...
			            .requestMatchers(HttpMethod.PUT , "/api/estimates/**").hasAuthority("ROLE_ADMIN")
